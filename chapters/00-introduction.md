...
The central argument is simple and contestable: the professional advantage in Calculus no longer comes from doing every step by hand. It comes from knowing what to delegate, what to verify, what to reject, and what human judgment must still own because the consequences attach to a person, a community, an institution, or a client.
...
Calculus: with LLMs is a guided course in the concepts, workflows, and judgment calls that define Calculus in the AI era. It teaches vocabulary, recurring patterns, practical exercises, and the discipline of checking machine output against human purpose.
...
1. **Chapter 1 — Functions and Graphs** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
2. **Chapter 2 — Limits** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
3. **Chapter 3 — Derivatives** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
4. **Chapter 4 — Applications of Derivatives** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
5. **Chapter 5 — Integration** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
6. **Chapter 6 — Applications of Integration** — This chapter develops one part of the book's argument and gives the reader a concrete place to practice it.
...
Calculus, AI+1, Humanitarians AI, Irreducibly Human, agentic AI, computational skepticism
