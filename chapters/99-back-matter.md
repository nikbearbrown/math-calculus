...
**Nik Bear Brown** teaches AI, data science, applied mathematics, and computational thinking at Northeastern University. The mathematical foundations of his research — computational and systems biology, machine learning, computational skepticism — rest on the same calculus this book teaches.

He holds a PhD in Computer Science from UCLA (computational and systems biology, AI, statistics), an MS in Information Design and Data Visualization, and an MBA from Northeastern. He is the founder of [Humanitarians AI](https://www.humanitarians.ai/) and the author of the *with LLMs* textbook series.
...
*Fun fact: in earlier lives, the author has been a photojournalist, a sumo wrestler, and a member of a traveling circus.*
